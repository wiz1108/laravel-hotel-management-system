                ...
                <div class="tabbable-custom tabbable-parallel"> 
                    ...
                    <div class="tab-pane active" id="customer"> 
                        <div class="table-container"> 
                            <table class="table table-striped table-hover" id ="datatable-people-agent" data-url="{{ route('getAgents') }}"> 
                                <thead>
                                    ...
                                    <tr role="row" class="filter"> 
                                        ...
                                        <td> 
                                            <input type="text" class="form-control form-filter filter-search input-sm filter-city" name="city" placeholder="City"> 
                                        </td> 
                                        <td> 
                                            <input type="text" class="form-control form-filter filter-search input-sm filter-creditLimit" name="creditLimit" placeholder="Credit Limit"> 
                                        </td> 
                                        <td> 
                                            <input type="text" class="form-control form-filter filter-search input-sm filter-commission" name="commission" placeholder="Commission"> 
                                        </td> 
                                        <td> 
...
@section('footer_script')
    ...
    <script src="{{asset('assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js' )}}"
            type="text/javascript"></script>
    <script src="{{asset('assets/scripts/pages/people/agent.js') }}" type="text/javascript"></script> 
