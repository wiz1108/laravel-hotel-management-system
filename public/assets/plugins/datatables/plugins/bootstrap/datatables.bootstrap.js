    ...
    "bootstrap_full_number": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<li class="prev disabled"><a href="#" style="font-weight: bold; font-size: 16px; border-style:none;background-color: #cfe5ea;" title="' + oLang.sPrevious + '">Prev</a></li>' +
                '<li class="next disabled"><a href="#" style="font-weight: bold; font-size: 16px; border-style:none;background-color: #cfe5ea;" title="' + oLang.sNext + '">Next</a></li>' +
